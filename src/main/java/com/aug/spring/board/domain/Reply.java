...
public class Reply {
	...
	public void setbUpdateDate(Date rUpdateDate) {
		this.rUpdateDate = rUpdateDate;
	}
	public char getUpdateYn() {
		return rUpdateYn;
	}
	public void setUpdateYn(char rUpdateYn) {
	...
	public String toString() {
		return "댓글 [댓글번호=" + replyNo + ", 게시글번호=" + refBoardNo + ", 댓글내용=" + replyContent
				+ ", 작성자=" + replyWriter + ", 작성일=" + rCreateDate + ", 수정일=" + rUpdateDate
				+ ", 수정여부=" + rUpdateYn + ", 사용여부=" + rStatus + "]";
	}
}
